...
END_CSS;
        ...
        return array(
            ...
            // Yellow on green.
            array('<span class="solarized_bg_green solarized_fg_yellow">foo</span>', $css, "\e[33;42mfoo\e[0m"),

            // Yellow on green - reversed.
            array('<span class="solarized_bg_yellow solarized_fg_green">foo</span>', $css, "\e[33;42;7mfoo\e[0m"),
        );
    }
}
